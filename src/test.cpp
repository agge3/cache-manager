 ...
 * @since 2024-09-21
 *
 * Testing suite for HandOverHandList concurrent implementation.
...
TEST_F(HandOverHandListTest, PopulationAndBasicOps) {
...
TEST_F(HandOverHandListTest, ConcurrentRandomInsertRemoveWithVerification) {
	this->ResetMetrics();
	this->populateList(this->initialSize);
	...
	this->PrintMetrics("ConcurrentRandomInsertRemoveWithVerification");
}

// Test 3: High contention scenario - all threads operate on same range
TEST_F(HandOverHandListTest, HighContentionSameRange) {
	this->ResetMetrics();
	...
	this->PrintMetrics("HighContentionSameRange");
}

// Test 4: Mostly inserts with few removes
TEST_F(HandOverHandListTest, InsertHeavyWorkload) {
	this->ResetMetrics();
	this->populateList(this->initialSize);
	...
	this->PrintMetrics("InsertHeavyWorkload");
}

// Test 5: Mostly removes with few inserts
TEST_F(HandOverHandListTest, RemoveHeavyWorkload) {
	this->ResetMetrics();
	...
	this->PrintMetrics("RemoveHeavyWorkload");
}

// Test 6: Edge cases - empty list, single element
TEST_F(HandOverHandListTest, EdgeCasesEmptyAndSingle) {
	this->ResetMetrics();
...
TEST_F(HandOverHandListTest, StressTestMaxConcurrency) {
	this->ResetMetrics();
	...
	this->PrintMetrics("StressTestMaxConcurrency");
}
...
TEST_F(HandOverHandListTest, ListConsistency) {
	...
	this->PrintMetrics("ListConsistency");
}
